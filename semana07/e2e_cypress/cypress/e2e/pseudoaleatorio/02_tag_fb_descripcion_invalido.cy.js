describe('Funcionalidad de crear tags', () => {
  const ESCENARIO = '02-tag-pseudoaleatorio-fb-descripcion-invalido';
  const SECCION = 'tags';
  let dataPool = {}
  ...
  it('Escenario 02 pseudoaleatorio: Crear tag con una descripcion invalida en la seccion facebook', () => {    
    ...
    const tagMetaTitle = dataPool.meta_title;
