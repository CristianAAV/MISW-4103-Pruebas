describe('Funcionalidad de crear member', () => {
  const ESCENARIO = 'member_crear_sin_nombre_correo_invalido_espacio'
  ...
  // el correo contiene un espacio
  it('Escenario # apriori: Crear member sin nombre y correo invalido espacio', () => {    
    cy.navegarSeccion(SECCION);
    cy.get(`a[href="#/${SECCION}/new/"]`).first().click();
    cy.finalizarPaso(`${ESCENARIO}_step02`);

    //Ingresar datos
    const email = dataPool.emailinvalids;
