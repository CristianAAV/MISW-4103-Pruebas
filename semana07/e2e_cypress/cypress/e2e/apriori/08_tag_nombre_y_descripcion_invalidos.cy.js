describe('Funcionalidad de crear tags', () => {
  const ESCENARIO = '08-tag-apriori-nombre-y-descripcion-invalidos'
  const SECCION = 'tags';
  let dataPool = {}
  ...
  it('Escenario 08 apriori: Crear tag cuyo nombre y descripcion son invalidos', () => {    
