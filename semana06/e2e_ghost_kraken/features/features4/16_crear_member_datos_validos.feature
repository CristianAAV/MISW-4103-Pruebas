...
Given I navigate to page "<URL1>"
  ...
  And I screenshotV4 "Escenario16" "step01"
  When I login to ghost "<EMAIL>" "<PASSWORD>"
  And I wait for 2 seconds
  And I screenshotV4 "Escenario16" "step02"
  Then I should be logged
  And I screenshotV4 "Escenario16" "step03"

  When I select the members section
  And I wait for 2 seconds
  And I screenshotV4 "Escenario16" "step04"
  Then I should have a new members button

  And I wait for 2 seconds
  And I screenshotV4 "Escenario16" "step05"

  When I click on the new members button
  And I wait for 2 seconds
  And I screenshotV4 "Escenario16" "step06"
  Then I should have a form to enter members information
  And I screenshotV4 "Escenario16" "step07"

  When I enter member Email
  And I wait for 2 seconds
  And I screenshotV4 "Escenario16" "step08"
  And I enter member name
  And I wait for 2 seconds
  And I screenshotV4 "Escenario16" "step09"
  And I click Save members
  And I wait for 3 seconds
  And I screenshotV4 "Escenario16" "step10"
  And I select the members section
  And I wait for 5 seconds
  And I screenshotV4 "Escenario16" "step11"
  Then I should have a new members on the list
  And I screenshotV4 "Escenario16" "step12"
  And I wait for 5 seconds
