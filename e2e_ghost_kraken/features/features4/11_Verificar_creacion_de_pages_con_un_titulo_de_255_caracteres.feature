Feature: My feature
 ...
 Scenario: Verificar creación de pages con un titulo de 255 caracteres
  ...
  And I screenshotV4 "Escenario11" "step01"
  And I wait for 1 seconds
  When I login to ghost "<EMAIL>" "<PASSWORD>"
  And I screenshotV4 "Escenario11" "step02"
  And I wait for 1 seconds
  Then I should be logged
  And I screenshotV4 "Escenario11" "step03"
  And I wait for 7 seconds
  Then I should be on the admin section v4
  And I screenshotV4 "Escenario11" "step04"
  When I click on the page 
  And I screenshotV4 "Escenario11" "step05"
  And I wait for 2 seconds
  And I click on the new pages
  And I screenshotV4 "Escenario11" "step06"
  And I wait for 2 seconds
  And I click on the redact message inputbox
  And I screenshotV4 "Escenario11" "step07"
  And I wait for 2 seconds
  And I enter text "Hola mundo"
  And I screenshotV4 "Escenario11" "step08"
  And I wait for 2 seconds
  And I redact text v4
  And I screenshotV4 "Escenario11" "step09"
  And I wait for 2 seconds
  And I click on the redact message inputbox
  And I screenshotV4 "Escenario11" "step10"
  ...
  And I screenshotV4 "Escenario11" "step11"
  And I wait for 2 seconds
  And I Publisher v4
  And I screenshotV4 "Escenario11" "step12"
  And I wait for 2 seconds
  And I Publisher final v4
  And I screenshotV4 "Escenario11" "step13"
  Then I should have error
  And I screenshotV4 "Escenario11" "step14"
  And I wait for 2 seconds
